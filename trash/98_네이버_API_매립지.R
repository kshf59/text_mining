...
query = URLencode(iconv("인천 서구 매립지", to="UTF-8"))
...
tb_api_news_reclaimed <- tb_api_news
...
## DB에 데이터 넣기
#dbClearResult(dbSendQuery(con,enc2utf8("drop table if exists tb_api_news_reclaimed;")))
#dbClearResult(dbSendQuery(con,enc2utf8("create table tb_api_news_reclaimed (
#                                              title text,
#                                              contents text,
#                                              link text,
#                                              date varchar(100)
...
#dbClearResult(dbSendQuery(con,enc2utf8("COMMENT ON COLUMN tb_api_news_reclaimed.title IS '뉴스제목';")))
#dbClearResult(dbSendQuery(con,enc2utf8("COMMENT ON COLUMN tb_api_news_reclaimed.contents IS '뉴스내용';")))
#dbClearResult(dbSendQuery(con,enc2utf8("COMMENT ON COLUMN tb_api_news_reclaimed.link IS '링크';")))
#dbClearResult(dbSendQuery(con,enc2utf8("COMMENT ON COLUMN tb_api_news_reclaimed.link IS '날짜';")))
dbWriteTable(conn = con,
             name = "tb_api_news_reclaimed",
             value = tb_api_news_reclaimed,
