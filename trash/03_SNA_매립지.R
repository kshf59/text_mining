...
## 세종시 국민신문고
r_sql <- c("select * from tb_api_news_reclaimed;")
...
## make 연광성 분석
keyword_aruls(dtm = dtm, supp = 0.007, conf = 0.25, minlen = 2)
...
rules_tmp <- apriori(tmp, parameter = list(supp = 0.05, conf = 0.05, minlen = 1))
